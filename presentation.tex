...
\author[B. Thalmann, S. Micheelsen, M. Larsen, M. Christensen]{
  Bruno Thalmann\\
...
% CONTENT
\input{slides/intro_and_context.tex}
\input{slides/attacktrees}
\input{slides/attack_pro_con}

\input{slides/security_models}
\input{slides/thesis_ideas}
